...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Tree-Based Decomposition of Health Inequality",
    Description = paste(
      "Provides tools for analysing socioeconomic inequality in health",
      "outcomes with tree-based models. The package supports",
      "inequality-aware recursive partitioning, weighted ranking and",
      "concentration-index utilities, subgroup interpretation, and",
      "SHAP-based decomposition of fitted outcomes into determinant",
      "contributions."
    ),
    `Authors@R` = c(
      person("Moses", "Mburu", 
      email = "mmburu20@gmail.com", 
      role = c("aut", "cre"), 
