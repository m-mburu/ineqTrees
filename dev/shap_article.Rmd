...
Then we approximate SHAP values with
[`shapr::explain()`](https://cran.r-project.org/web/packages/shapr/index.html),
decompose the concentration index of the fitted risks, and plot the feature
contributions.
...
This chunk defines prediction wrappers for `shapr`. Each wrapper accepts a
...
decomposes the concentration index of those fitted risks.
