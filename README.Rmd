...
Approximate SHAP values with `fastshap::explain()`, using a prediction wrapper
that returns the predicted outcome for each observation, then decompose the
concentration index of those predicted risks with `shap_conc_decomp()`. See the
