...
for fitting greedy concentration-index trees and forests. Open the
[inequality-aware party trees article](https://m-mburu.github.io/ineqTrees/articles/inequality-aware-party-trees.html)
for more detail on how these trees define the two-column response, choose
concentration-index splits, tune controls, and summarize terminal subgroups.
...
predictions of the fitted forest. This is useful for interpreting the forest,
since the surrogate can be refit on held-out data and scored with CI gain.
